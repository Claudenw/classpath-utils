 ...
 * <p>
 * This class captures difference case sensitivity, providing an enumeration to
...
public final class Case implements Serializable {
	 ...
	 */
	public static final Case SENSITIVE = new Case("Sensitive", true);

	/**
	 * The constant for case insensitive regardless of operating system.
	 */
	public static final Case INSENSITIVE = new Case("Insensitive", false);
	...
	public static Case forName(String name) {
		if (Case.SENSITIVE.name.equals(name)) {
			return Case.SENSITIVE;
		}
		if (Case.INSENSITIVE.name.equals(name)) {
			return Case.INSENSITIVE;
		}
		throw new IllegalArgumentException("Invalid Case name: " + name);
	}
	 ...
	 *            the sensitivity
	 */
	private Case(String name, boolean sensitive) {
		this.name = name;
